...
export default function FloatingBookButton() {
  ...
  return (
    <a
      ...
      className={`group fixed right-6 bottom-6 z-40 grid h-16 grid-cols-[4rem_0fr] items-center overflow-hidden rounded-full bg-clay text-olive-900 shadow-lg transition-all duration-300 ease-out hover:grid-cols-[4rem_1fr] hover:bg-clay-light sm:right-12 sm:bottom-12 sm:h-[100px] sm:grid-cols-[100px_0fr] sm:hover:grid-cols-[100px_1fr] ${
